...
Under the hood the script is executing such flow:

1. Install [kind](https://github.com/kubernetes-sigs/kind) (kubernetes-in-docker) and [Helm](https://github.com/helm/helm).
1. Provision Kubernetes cluster using kind.
